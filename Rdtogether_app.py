...
def about_ray_dream():
    ...
    ✔️ พัฒนา UI สำหรับ AI โต้ตอบผ่านเว็บ โดยใช้ภาษา python ในการดึงapiและสร้างฟังชั้นการใช้งานต่างๆ และนำ css มาตบแต่งหน้าUIรวมถึงการสร้าง dashboard และดึงข้อมูลจากเว็บต่างๆมาใช้งาน<br>
    ✔️ โมเดลที่รันแบบ local Host มีระบบโต้ตอบด้วยเสียง Gtts และสามารถค้นหาข้อมูลผ่านอินเทอร์เน็ต โดยเก็บสิ่งที่ไปค้นหาเป็นความจำควบคู่กับการสนทนาแบบปกติและยังมีการรับรู้เหมือนเอไอคอยอ่านข่าวล่าสุดอยู่ตลอดเวลา <br>
