...
def about_ray_dream():
    ...
    <div class="resume-text">
    🔥 พัฒนาระบบ AI ที่สามารถ เรียนรู้พฤติกรรมผู้ใช้แบบเรียลไทม์และวิเคราะห์สิ่งที่พึ่งคุยเพื่ออัพเดทบนสนทนาในรอบใหม่<br>
...
def dashboard():
    ...
    try:
        ...
        for url in feed_urls:
            ...
            for entry in feed.entries[:5]:  # ดึง 5 ข่าวล่าสุด
